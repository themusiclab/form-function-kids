/**
 * jspsych-audio-imageButton-response-loop
 * Kristin Diep
 *
...
jsPsych.plugins["audio-imageButton-response-loop"] = (function() {
	var plugin = {};

	jsPsych.pluginAPI.registerPreload('audio-imageButton-response-loop', 'stimulus', 'audio');

	plugin.info = {
		name: 'audio-imageButton-response-loop',
		description: '',
		parameters: {
			stimulus: {
