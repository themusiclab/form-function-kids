/**
 * jspsych-audio-button-response-loop
 * Kristin Diep
 *
...
jsPsych.plugins["audio-button-response-loop"] = (function() {
	var plugin = {};

	jsPsych.pluginAPI.registerPreload('audio-button-response-loop', 'stimulus', 'audio');

	plugin.info = {
		name: 'audio-button-response-loop',
		description: '',
		parameters: {
			stimulus: {
