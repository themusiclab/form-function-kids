/**
 * jspsych-audio-button-response-training-td
 * Kristin Diep
 *
...
jsPsych.plugins["audio-button-response-training-td"] = (function() {
	var plugin = {};

	jsPsych.pluginAPI.registerPreload('audio-button-response-training-td', 'stimulus', 'audio');

	plugin.info = {
		name: 'audio-button-response-training-td',
		description: '',
		parameters: {
			stimulus: {
