/**
 * jspsych-audio-button-response-td
 * Kristin Diep
 *
...
jsPsych.plugins["audio-button-response-td"] = (function() {
	var plugin = {};

	jsPsych.pluginAPI.registerPreload('audio-button-response-td', 'stimulus', 'audio');

	plugin.info = {
		name: 'audio-button-response-td',
		description: '',
		parameters: {
			stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var html = '<div id="jspsych-audio-button-response-training-btngroup">';
      ...
      html += '<div class="jspsych-audio-button-response-training-button" style="cursor: pointer; display: inline-block; margin:'+trial.margin_vertical+' '+trial.margin_horizontal+'" id="jspsych-audio-button-response-training-button-' + 0 +'" data-choice="'+0+'"><img src='+trial.choices[0]+' width='+trial.button_width+'></div>'
			...
			html += '<div class="jspsych-audio-button-response-training-button" style="cursor: pointer; display: inline-block; margin:'+trial.margin_vertical+' '+trial.margin_horizontal+'" id="jspsych-audio-button-response-training-button-' + 1 +'" data-choice="'+1+'"><img src='+trial.choices[1]+' width='+trial.button_width+'></div>';
console.log(trial.choices)
    ...
    function end_trial() {
			...
			if(context !== null){
				...
				//audio.pause(); /* commented out to prevent audio from ending after trial ends, remove // to add back in */
