...
jsPsych.plugins["audio-countdown-keyboard-response"] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      default:false,
      description: 'keeping track of what kind of audio file this is'
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if(context !== null){
      ...
      duration = Math.round(source.buffer.duration);
    } else {
    ...
    function myTimer () {
      textElement.innerHTML = '<font size=24 color=#F34235><b>'+seconds+'</b></font>';
      if (--seconds < 0) {
          seconds = 0;
       }
    }
