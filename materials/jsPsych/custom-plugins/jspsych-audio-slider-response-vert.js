jsPsych.plugins['audio-slider-response-vert'] = (function() {
	var plugin = {};

	jsPsych.pluginAPI.registerPreload('audio-slider-response-vert', 'stimulus', 'audio');

	plugin.info = {
		name: 'audio-slider-response-vert',
		description: '',
    parameters: {
      stimulus: {
